...
public:
	...
	virtual int const& GetRenderOrigin() = 0;
	virtual int const& GetRenderAngles() = 0;
	...
	virtual bool					SetupBones(int* pBoneToWorldOut, int nMaxBones, int boneMask, float currentTime) = 0;
	virtual void					SetupWeights(const int* pBoneToWorld, int nFlexWeightCount, float* pFlexWeights, float* pFlexDelayedWeights) = 0;
	virtual void					DoAnimationEvents(void) = 0;
	virtual void* GetPVSNotifyInterface() = 0;
	virtual void					GetRenderBounds(int& mins, int& maxs) = 0;
	virtual void					GetRenderBoundsWorldspace(int& mins, int& maxs) = 0;
	virtual void					GetShadowRenderBounds(int& mins, int& maxs, void* shadowType) = 0;
	virtual bool					ShouldReceiveProjectedTextures(int flags) = 0;
	virtual bool					GetShadowCastDistance(float* pDist, void* shadowType) const = 0;
	virtual bool					GetShadowCastDirection(int* pDirection, void* shadowType) const = 0;
	...
	virtual const int& RenderableToWorldTransform() = 0;
	virtual int						LookupAttachment(const char* pAttachmentName) = 0;
	virtual	bool					GetAttachment(int number, int& origin, int& angles) = 0;
	virtual bool					GetAttachment(int number, int& matrix) = 0;
...
public:
	...
	/*3*/	virtual int* GetCollideable(void) = 0;
	...
	/*9*/	virtual int& GetAbsOrigin(void)const = 0;
	/*10*/	virtual int& GetAbsAngles(void)const = 0;
	/*11*/	virtual void* GetMouth(void) = 0;
	/*12*/	virtual void* GetSoundSpatialization(int&) = 0;
	...
	/*16*/	virtual void* FireBullets(int const&) = 0;
	/*17*/	virtual void* ModifyFireBulletsDamage(int*) = 0;
	/*18*/	virtual bool ShouldDrawUnderwaterBulletBubbles(void) = 0;
	/*19*/	virtual bool ShouldDrawWaterImpacts(void) = 0;
	/*20*/	virtual void* HandleShotImpactingWater(int const&, int const&, int*, int*) = 0;
	/*21*/	virtual void* GetBeamTraceFilter(void) = 0;
	/*22*/	virtual void* DispatchTraceAttack(int const&, int const&, int*, void*) = 0;
	/*23*/	virtual void* TraceAttack(int const&, int const&, int*, void*) = 0;
	/*24*/	virtual void* DoImpactEffect(int&, int) = 0;
	/*25*/	virtual void* MakeTracer(int const&, int const&, int) = 0;
	...
	/*39*/	virtual void* KeyValue(char const*, int const&) = 0;
	...
	/*66*/	virtual void* TestCollision(int const&, unsigned int, int&) = 0;
	/*67*/	virtual void* TestHitboxes(int const&, unsigned int, int&) = 0;
	...
	/*110*/	virtual void* ComputeWorldSpaceSurroundingBox(int*, int*) = 0;
	/*111*/	virtual void* GetSolid(void)const = 0;
	/*112*/	virtual void* GetSolidFlags(void)const = 0;
	/*115*/	virtual void* GetAttachment(int, int&) = 0;
	/*117*/	virtual void* GetAttachmentVelocity(int, int&, int&) = 0;
	...
	/*132*/	virtual void* GetAimEntOrigin(void*, int*, int*) = 0;
	...
	/*162*/	virtual void* AddDecal(int const&, int const&, int const&, int, int, bool, int&, int) = 0;
	...
	/*169*/	virtual void* DecalTrace(int*, char const*) = 0;
	/*170*/	virtual void* ImpactTrace(int*, int, char const*) = 0;
	/*171*/	virtual bool ShouldPredict(void) = 0;
	/*172*/	virtual void* Think(void) = 0;
	/*173*/	virtual void* CanBePoweredUp(void) = 0;
	/*174*/	virtual void* AttemptToPowerup(int, float, float, CBaseEntity*, void*) = 0;
	/*175*/	virtual bool IsCurrentlyTouching(void)const = 0;
	/*176*/	virtual void* StartTouch(CBaseEntity*) = 0;
	/*177*/	virtual void* Touch(CBaseEntity*) = 0;
	/*178*/	virtual void* EndTouch(CBaseEntity*) = 0;
	...
	/*191*/	virtual int EyePosition(void) = 0;
	/*192*/	virtual int& EyeAngles(void) = 0;
	/*193*/	virtual int& LocalEyeAngles(void) = 0;
	/*194*/	virtual int EarPosition(void) = 0;
	/*195*/	virtual bool ShouldCollide(int, int)const = 0;
	/*196*/	virtual int& GetViewOffset(void) = 0;
	/*197*/	virtual void SetViewOffset(int const&) = 0;
	...
	/*221*/	virtual void SetMaterialOverridePointer(int*) = 0;
	/*222*/	virtual int* GetMaterialOverridePointer(void) = 0;
	...
	/*235*/	virtual void* SetEntity(char const*, CBaseEntity*) = 0;
	...
	/*242*/	virtual void* GetCustomisedRenderBounds(int&, int&) = 0;
	/*243*/	virtual void* SetCustomisedRenderBounds(int*, int*) = 0;
	...
	/*267*/	virtual void* BuildTransformations(void*, int*, int*, int const&, int, void*, int const*) = 0;
	/*268*/	virtual void* ApplyBoneMatrixTransform(int&) = 0;
	...
	/*276*/	virtual void* FireEvent(int const&, int const&, int, char const*) = 0;
	/*277*/	virtual void* FireObsoleteEvent(int const&, int const&, int, char const*) = 0;
	...
	/*281*/	virtual void* StandardBlendingRules(void*, int*, int*, float, int) = 0;
	/*282*/	virtual void* AccumulateLayers(void*, int*, int*, float) = 0;
	/*283*/	virtual void* ChildLayerBlend(int*, int*, float, int) = 0;
	/*284*/	virtual void* AttachEntityToBone(void*, int, int, int) = 0;
	...
	/*289*/	virtual void* SaveRagdollInfo(int, int const&, void*) = 0;
	/*290*/	virtual void* RetrieveRagdollInfo(int*, int*) = 0;
	/*291*/	virtual void* GetRagdollInitBoneArrays(int*, int*, int*, float) = 0;
	...
	/*301*/	virtual void* UncorrectViewModelAttachment(int&) = 0;
	...
	/*308*/	virtual void* FormatViewModelAttachment(int, int&) = 0;
	...
	/*313*/	virtual void* SetOverrideViewTarget(int) = 0;
	...
	/*324*/	virtual void* SetupGlobalWeights(int const*, int, float*, float*) = 0;
	/*325*/	virtual void* SetupLocalWeights(int const*, int, float*, float*) = 0;
	/*326*/	virtual void* SetViewTarget(void*) = 0;
	/*327*/	virtual void* StartSceneEvent(void*, void*, void*, void*, CBaseEntity*) = 0;
	...
	/*335*/	virtual bool IsLookingTowards(int const&, float)const = 0;
	/*336*/	virtual bool IsInFieldOfView(CBaseEntity*)const = 0;
	/*337*/	virtual bool IsInFieldOfView(int const&)const = 0;
	/*338*/	virtual bool IsLineOfSightClear(CBaseEntity*, LineOfSightCheckType)const = 0;
	/*339*/	virtual bool IsLineOfSightClear(int const&, LineOfSightCheckType, CBaseEntity*)const = 0;
	/*340*/	virtual void* Weapon_Switch(void*, int) = 0;
	/*341*/	virtual void* Weapon_CanSwitchTo(void*) = 0;
	/*342*/	virtual int* GetActiveWeapon(void)const = 0;
	...
	/*346*/	virtual void* CalcView(int&, int&, float&, float&, float&) = 0;
	/*347*/	virtual void* CalcViewModelView(int const&, int const&) = 0;
	/*348*/	virtual void* CalcRoll(int const&, int const&, float, float) = 0;
	...
	/*352*/	virtual int GetAutoaimint(float flDelta) = 0;
	/*353*/	virtual void* CreateMove(float, int*) = 0;
	/*354*/	virtual void* AvoidPhysicsProps(int*) = 0;
	/*355*/	virtual void* PlayerUse(void) = 0;
	/*356*/	virtual bool IsUseableEntity(CBaseEntity*, unsigned int) = 0;
	...
	/*380*/	virtual void* Weapon_SetLast(int*) = 0;
	/*381*/	virtual void* Weapon_ShouldSetLast(int*, int*) = 0;
	/*382*/	virtual void* Weapon_ShouldSelectItem(int*) = 0;
	...
	/*388*/	virtual void* ViewPunch(int const& angleOffset) = 0;
	...
	/*394*/	virtual void* SetAnimation(int) = 0;
	/*395*/	virtual double GetMinFOV(void)const = 0;
	/*396*/	virtual void* PlayPlayerJingle(void) = 0;
	/*397*/	virtual void* UpdateStepSound(void*, int const&, int const&) = 0;
	/*398*/	virtual void* PlayStepSound(int&, void*, float, bool) = 0;
	/*399*/	virtual void* GetFootstepSurface(int const&, char const*) = 0;
	...
	/*403*/	virtual void* OnEmitFootstepSound(int const&, int const&, float) = 0;
	...
	/*409*/	virtual int CalcObserverView(int&, int&, float&) = 0;
	/*410*/	virtual void* GetChaseCamViewOffset(CBaseEntity*) = 0;
	/*411*/	virtual void* CalcInEyeCamView(int&, int&, float&) = 0;
	/*412*/	virtual double GetDeathCamInterpolationTime(void) = 0;
	/*413*/	virtual float* CalcDeathCamView(int&, int&, float&) = 0;
	/*414*/	virtual void* CalcFreezeCamView(int&, int&, float&) = 0;
	/*415*/	virtual int SetLocalViewAngles(int const&) = 0;
	/*416*/	virtual int SetViewAngles(int const&) = 0;
