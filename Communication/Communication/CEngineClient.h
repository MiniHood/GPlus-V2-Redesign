...
{
public:
	/*0*/	virtual void* GetIntersectingSurfaces(int) = 0;
	/*1*/	virtual void* GetLightForPoint(int) = 0;
	/*2*/	virtual void* TraceLineMaterialAndLighting(int) = 0;
	...
	/*19*/	virtual void GetViewAngles(int) = 0;
	/*20*/	virtual void SetViewAngles(int) = 0;
	...
	/*31*/	virtual bool IsBoxVisible(int) = 0;
	/*32*/	virtual bool IsBoxInViewCluster(int) = 0;
	/*33*/	virtual void* CullBox(int) = 0;
	...
	/*45*/	virtual void* ComputeDynamicLighting(int) = 0;
	/*46*/	virtual void* GetAmbientLightColor(int) = 0;
	...
	/*58*/	virtual void* DoesBoxTouchAreaFrustum(int) = 0;
	...
	/*67*/	virtual void* ComputeLighting(int) = 0;
	/*68*/	virtual void* ActivateOccluder(int, bool) = 0;
	/*69*/	virtual bool IsOccluded(int) = 0;
	...
	/*73*/	virtual void* DebugDrawPhysCollide(int) = 0;
	...
	/*92*/	virtual bool IsSkyboxVisibleFromPoint(int) = 0;
	...
	/*105*/	virtual void* GetLightForPointFast(int) = 0;
